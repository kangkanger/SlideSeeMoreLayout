...
public class SlideSeeMoreLayout  extends ViewGroup {
    /**
...
public interface OnSlideDetailsListener {
    ...
    public SlideSeeMoreLayout(Context context) {
        this(context, null);
    }

    public SlideSeeMoreLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideSeeMoreLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new ViewGroup.MarginLayoutParams(ViewGroup.MarginLayoutParams.WRAP_CONTENT, ViewGroup.MarginLayoutParams.WRAP_CONTENT);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        final int pWidth = View.MeasureSpec.getSize(widthMeasureSpec);
        final int pHeight = View.MeasureSpec.getSize(heightMeasureSpec);

        final int childWidthMeasureSpec =
                View.MeasureSpec.makeMeasureSpec(pWidth, View.MeasureSpec.EXACTLY);
        final int childHeightMeasureSpec =
                View.MeasureSpec.makeMeasureSpec(pHeight, View.MeasureSpec.EXACTLY);
